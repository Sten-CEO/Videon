        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-xl bg-[#F5F5F4] flex items-center justify-center text-[#52525B] hover:bg-[#0D9488] hover:text-white transition-colors">
          ...
          {/* Product links */}
          <div>
            <h4 className="text-sm font-semibold text-[#18181B] mb-4" style={{ fontFamily: 'var(--font-display)' }}>
              Product
            </h4>
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-[#52525B] hover:text-[#0D9488] transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
