    ...
    <Card padding="lg">
      <CardHeader>
        ...
        <CardDescription className="text-center">
          Sign in to your Videon account
        </CardDescription>
      </CardHeader>
      ...
      <CardContent>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-background-secondary text-foreground-subtle">
              or continue with
            </span>
          </div>
        </div>
  ...
  return (
    <Card padding="lg">
      <div className="animate-pulse space-y-4">
        <div className="h-8 bg-background-tertiary rounded w-1/2 mx-auto" />
        <div className="h-4 bg-background-tertiary rounded w-2/3 mx-auto" />
